...
Adder16::Adder16(const std::string& initName) :
...
void Adder16::AttachEnable(Io* io) {
...
void Adder16::AttachInputBusA(Bus16* bus) {
...
void Adder16::AttachInputBusB(Bus16* bus) {
	...
	faddr8.AttachInput2(&bus->bits[8]);
	faddr9.AttachInput2(&bus->bits[9]);
	faddr10.AttachInput2(&bus->bits[10]);
	faddr11.AttachInput2(&bus->bits[11]);
	faddr12.AttachInput2(&bus->bits[12]);
	faddr13.AttachInput2(&bus->bits[13]);
	faddr14.AttachInput2(&bus->bits[14]);
	faddr15.AttachInput2(&bus->bits[15]);
}


void Adder16::AttachOutputBus(Bus16* bus) {
