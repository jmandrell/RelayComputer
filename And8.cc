...
And8::And8(const std::string& initName) :
	name(initName),
	gate0(name + " gate0"),
	gate1(name + " gate1"),
	gate2(name + " gate2"),
...
void And8::AttachInputBusA(Bus8* bus) {
...
void And8::AttachInputBusB(Bus8* bus) {
...
void And8::AttachOutputBus(Bus8* bus) {
